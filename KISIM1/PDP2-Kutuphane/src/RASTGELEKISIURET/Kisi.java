...
* @since 19/04/2020
* 
* Kisi.java sinifinda kişi oluşturdum  ve kontrolleri gerçekleştirdim
* 
*/
public class Kisi extends Rastgele {
    ...
    String bilgileri_dondur;
    
    
    //kişilerin bilgilerini metotlar yardımı ile çağırdım
    
  public String YeniKisi() throws FileNotFoundException{
  ...
  public boolean TcNumarasiKontrol(String TcNu){
...
public boolean Imei_numarasiKontrol(String imeNu){
    boolean sonuc = true;
      double cift_sayi=0;
      double tek_sayi=0;
      String Imei_ekle="";
